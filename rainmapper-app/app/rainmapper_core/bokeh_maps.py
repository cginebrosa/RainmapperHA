...
def main():
    ...
    maps_to_generate = [
        ('07_Tomap_Last_three_months', 'Pluja últims 3 mesos - a '),
        ('06_Tomap_Last_two_months', 'Pluja últims 2 mesos - a '),
        ('05_Tomap_Last_month', 'Pluja últim mes - a '),
        ('04_Tomap_Last_three_weeks', 'Pluja últimes 3 setmanes - a '),
        ('03_Tomap_Last_two_weeks', 'Pluja últimes 2 setmanes - a '),
        ('02_Tomap_Last_week', 'Pluja última setmana - a '),
        ('01_Tomap_Last_day', 'Pluja últim dia - a '),
    ]
