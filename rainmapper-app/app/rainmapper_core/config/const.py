...
_script_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..'))
...
_meteocat_request_timeout = _int_env('RAINMAPPER_METEOCAT_REQUEST_TIMEOUT', 30)  # Seconds before a Meteocat/Socrata request times out
_meteocat_max_attempts = _int_env('RAINMAPPER_METEOCAT_MAX_ATTEMPTS', 3)  # Attempts for Meteocat/Socrata requests
