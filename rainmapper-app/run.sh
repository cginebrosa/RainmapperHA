...
PY
  ...
  print_blue "Predictor weekly model selection: ${PREDICTOR_WEEKLY_MODEL_SELECTION_VALUE}"
  ...
  print_blue "Predictor precompute path: $(python -c 'from rainmapper_core.mushroom_paths import mushroom_predictor_precompute_dir; print(mushroom_predictor_precompute_dir())')"
  print_blue "Reconstructible mushroom data path: $(python -c 'from rainmapper_core.mushroom_paths import mushroom_derived_data_dir; print(mushroom_derived_data_dir())')"
  print_blue ""
  print_blue "-------------------------------------------------------------------------------"
...
ML_STORAGE_RECONCILIATION_APPLY_VALUE="$(option ml_storage_reconciliation_apply false)"
...
PREDICTOR_WEEKLY_MODEL_SELECTION_VALUE="$(option predictor_weekly_model_selection false)"
...
export RAINMAPPER_ML_STORAGE_RECONCILIATION_APPLY="$ML_STORAGE_RECONCILIATION_APPLY_VALUE"
...
export RAINMAPPER_MAPLIBRE_OBSERVATIONS_MOBILE_ENABLED="$(option maplibre_observations_mobile_enabled false)"
