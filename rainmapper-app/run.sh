...
MAPLIBRE_ESTIMATED_FIELD_RADIUS_MEDIUM_KM_VALUE="$(option maplibre_estimated_field_radius_medium_km 25)"
MAPLIBRE_ESTIMATED_FIELD_RADIUS_LARGE_KM_VALUE="$(option maplibre_estimated_field_radius_large_km 50)"
MAPLIBRE_ESTIMATED_FIELD_MAX_RADIUS_KM_VALUE="$(option maplibre_estimated_field_max_radius_km 100)"
MAPLIBRE_ESTIMATED_FIELD_GRID_LOW_CELL_KM_VALUE="$(option maplibre_estimated_field_grid_low_cell_km 10)"
MAPLIBRE_ESTIMATED_FIELD_GRID_MEDIUM_CELL_KM_VALUE="$(option maplibre_estimated_field_grid_medium_cell_km 5)"
MAPLIBRE_ESTIMATED_FIELD_GRID_HIGH_CELL_KM_VALUE="$(option maplibre_estimated_field_grid_high_cell_km 2.5)"
