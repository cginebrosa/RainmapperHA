...
MAPLIBRE_HEATMAP_OPACITY_VALUE="$(option maplibre_heatmap_opacity 65)"
...
MAPLIBRE_ESTIMATED_FIELD_OPACITY_VALUE="$(option maplibre_estimated_field_opacity 65)"
...
MAPLIBRE_ESTIMATED_FIELD_RADIUS_SMALL_PX_VALUE="$(option maplibre_estimated_field_radius_small_px 80)"
MAPLIBRE_ESTIMATED_FIELD_RADIUS_MEDIUM_PX_VALUE="$(option maplibre_estimated_field_radius_medium_px 140)"
MAPLIBRE_ESTIMATED_FIELD_RADIUS_LARGE_PX_VALUE="$(option maplibre_estimated_field_radius_large_px 220)"
MAPLIBRE_ESTIMATED_FIELD_MAX_RADIUS_KM_VALUE="$(option maplibre_estimated_field_max_radius_km 100)"
MAPLIBRE_ESTIMATED_FIELD_GRID_LOW_COLS_VALUE="$(option maplibre_estimated_field_grid_low_cols 80)"
MAPLIBRE_ESTIMATED_FIELD_GRID_LOW_ROWS_VALUE="$(option maplibre_estimated_field_grid_low_rows 50)"
MAPLIBRE_ESTIMATED_FIELD_GRID_MEDIUM_COLS_VALUE="$(option maplibre_estimated_field_grid_medium_cols 120)"
MAPLIBRE_ESTIMATED_FIELD_GRID_MEDIUM_ROWS_VALUE="$(option maplibre_estimated_field_grid_medium_rows 80)"
MAPLIBRE_ESTIMATED_FIELD_GRID_HIGH_COLS_VALUE="$(option maplibre_estimated_field_grid_high_cols 180)"
MAPLIBRE_ESTIMATED_FIELD_GRID_HIGH_ROWS_VALUE="$(option maplibre_estimated_field_grid_high_rows 120)"
...
export RAINMAPPER_MAPLIBRE_ESTIMATED_FIELD_RADIUS_SMALL_PX="$MAPLIBRE_ESTIMATED_FIELD_RADIUS_SMALL_PX_VALUE"
export RAINMAPPER_MAPLIBRE_ESTIMATED_FIELD_RADIUS_MEDIUM_PX="$MAPLIBRE_ESTIMATED_FIELD_RADIUS_MEDIUM_PX_VALUE"
export RAINMAPPER_MAPLIBRE_ESTIMATED_FIELD_RADIUS_LARGE_PX="$MAPLIBRE_ESTIMATED_FIELD_RADIUS_LARGE_PX_VALUE"
export RAINMAPPER_MAPLIBRE_ESTIMATED_FIELD_MAX_RADIUS_KM="$MAPLIBRE_ESTIMATED_FIELD_MAX_RADIUS_KM_VALUE"
export RAINMAPPER_MAPLIBRE_ESTIMATED_FIELD_GRID_LOW_COLS="$MAPLIBRE_ESTIMATED_FIELD_GRID_LOW_COLS_VALUE"
export RAINMAPPER_MAPLIBRE_ESTIMATED_FIELD_GRID_LOW_ROWS="$MAPLIBRE_ESTIMATED_FIELD_GRID_LOW_ROWS_VALUE"
export RAINMAPPER_MAPLIBRE_ESTIMATED_FIELD_GRID_MEDIUM_COLS="$MAPLIBRE_ESTIMATED_FIELD_GRID_MEDIUM_COLS_VALUE"
export RAINMAPPER_MAPLIBRE_ESTIMATED_FIELD_GRID_MEDIUM_ROWS="$MAPLIBRE_ESTIMATED_FIELD_GRID_MEDIUM_ROWS_VALUE"
export RAINMAPPER_MAPLIBRE_ESTIMATED_FIELD_GRID_HIGH_COLS="$MAPLIBRE_ESTIMATED_FIELD_GRID_HIGH_COLS_VALUE"
export RAINMAPPER_MAPLIBRE_ESTIMATED_FIELD_GRID_HIGH_ROWS="$MAPLIBRE_ESTIMATED_FIELD_GRID_HIGH_ROWS_VALUE"
