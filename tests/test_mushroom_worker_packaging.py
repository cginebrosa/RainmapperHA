...
class MushroomWorkerPackagingTests(unittest.TestCase):
    def test_worker_image_is_minimal_and_uses_python_311(self) -> None:
        ...
        self.assertIn("ARG RAINMAPPER_WORKER_VERSION=1.1.6", dockerfile)
        ...
        self.assertIn("mushroom_ml_reliability_audit.py", dockerfile)
        ...
        self.assertIn("mushroom_performance_telemetry.py", dockerfile)
        self.assertIn("mushroom_worker_jobs.py", dockerfile)
        self.assertIn("mushroom_prediction_interpretation.py", dockerfile)
        self.assertIn("mushroom_predictor_precompute.py", dockerfile)
        self.assertIn("mushroom_predictor_precompute_control.py", dockerfile)
    ...
    def test_ha_image_packages_coordinator_without_enabling_it(self) -> None:
        ...
        self.assertIn("rainmapper-app/app/mushroom_observation_gis_ui.py", dockerfile)
        self.assertIn("rainmapper-app/app/observation-gis.js", dockerfile)
        self.assertIn("rainmapper-app/app/observation-map-gis.js", dockerfile)
        self.assertIn("scripts/recover-mushroom-forest.py", dockerfile)
        self.assertIn("run-mushroom-rebuild-job.py", dockerfile)
    ...
    def test_local_worker_service_is_startable_and_stoppable_without_volume_deletion(self) -> None:
        ...
        self.assertIn(
            "image: rainmapper-worker:${RAINMAPPER_WORKER_VERSION:-1.1.6}",
            compose,
        )
        self.assertIn(
            "RAINMAPPER_WORKER_VERSION: ${RAINMAPPER_WORKER_VERSION:-1.1.6}",
            compose,
        )
