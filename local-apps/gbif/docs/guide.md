...
## Ubicación actual (19/09/2026)

Código: `local-apps/gbif/code/`. Datos, fotografías y snapshots:
`local-apps/gbif/data/`. Arranque: `./local-apps/gbif/start.command`.
Las rutas antiguas de los snapshots son enlaces de compatibilidad, sin copias,
para mantener los marcadores y la URL usada por las revisiones del navegador.
Los archivos de revisión elegidos fuera del repo no se han movido ni modificado.

## Abrir en local

- [Visor MapLibre de observaciones](../data/snapshot-catalunya-20120619-20260916-full/index.html).
- [Galería sin conexión](../data/snapshot-catalunya-20120619-20260916-full/gallery.html).
- [Descripción, estructura y tabla por especie](../data/snapshot-catalunya-20120619-20260916-full/README.md).
- [Tabla CSV de revisión](../data/snapshot-catalunya-20120619-20260916-full/review.csv).
- [Validación de la descarga](../data/snapshot-catalunya-20120619-20260916-full/validation.json).
- [Inventario final y huellas](../data/snapshot-catalunya-20120619-20260916-full/offline-manifest.json).
...
[Resultados y fuentes](../data/snapshot-catalunya-20120619-20260916-full/metadata/geography.json).
