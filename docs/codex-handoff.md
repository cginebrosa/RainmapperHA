...
Actualizacion del 2026-06-24: tras subir el backfill AEMET de `tmp/aemet-backfill-0.2.114-output/Aemet_incremental.csv`, un run AEMET en HA preservo el rango `20260525`-`20260624`, no creo duplicados y relleno viento en filas recientes generadas desde horario. Despues se publico `0.2.115` en GHCR con propagacion de humedad/viento a Tomap/GeoJSON y su visualizacion en popups MapLibre; digest multi-arch `sha256:b2c5b74474f3539d84d57efe623f5174c5e5bbf7b0c5f1418d0c51b04f3ba359`. Validacion local: `unittest`, `scripts/check-history.py docker-data/Data`, `scripts/smoke-test.sh` y generacion temporal `tmp/weather-popup-check/` OK. Siguiente paso recomendado: instalar/actualizar `0.2.115` en HA y validar visualmente popups en movil/escritorio.
