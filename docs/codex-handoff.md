...
- El repo GitHub es privado; el paquete GHCR debe quedar accesible para HA. Estado remoto verificado el 2026-06-24: `0.2.113` esta validada en HA y GHCR conserva solo `0.2.113`, `latest` y las cuatro entradas auxiliares del mismo push multi-arch. Tras futuras versiones HA validadas, limpiar versiones remotas antiguas conservando solo la version vigente, `latest` y las entradas auxiliares del mismo push multi-arch.
