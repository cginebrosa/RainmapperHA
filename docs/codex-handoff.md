...
- El repo GitHub queda privado salvo ventanas operativas para que HA detecte updates. Estado actual tras validar `0.2.133`: repo privado (`private=true`, `visibility=private`, rama `inicial`). `0.2.133/latest` queda publicado en GHCR con digest multi-arch `sha256:d0b6432a123b718a5ad58ed990b48a7847589b8e74d4487ea1010787d2a775f2`; GHCR conserva solo `0.2.133,latest` y cuatro auxiliares sin tag del mismo push multi-arch.
