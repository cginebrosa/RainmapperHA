...
Actualizacion HA `0.2.150` publicada el 2026-06-27: imagen `ghcr.io/cginebrosa/rainmapperha:0.2.150` y `latest` con digest multi-arch `sha256:35e42628eeb0937ec800608e9251fa0ef8148d4f6a626aea52a13a341ba71c0f`; commit de release `ecf2ed8`. Cambios principales: defaults versionados `mushroom-data/` incluidos en la imagen, backend/store persistente en `/share/rainmapper/mushroom-data/`, endpoints admin de validacion/import/export/plantilla, WebUI `/mushrooms/catalogs` con busqueda/filtros, detalle JSON editable, creacion de entradas por grupo, validacion cruzada e import/export/plantilla del catalogo completo. Validacion local antes de publicar: `./scripts/smoke-test.sh` OK con 97 tests. Pendiente de validacion visual/operativa en HA.
