...
- [ ] Observar prueba externa con usuarios reales
  ...
  - Estado: prueba en curso. HA ejecuta `Run all` con schedule `01:45 - 05:00 - 08:00 - 11:00 - 14:00 - 17:00 - 20:00 - 23:55`. `0.2.101` quedo validada manualmente para WebUI `Users`; `0.2.102` queda publicada con AEMET opcional y pendiente de instalar/validar en HA.
