...
`0.2.122` es la version HA actual en `rainmapper-app/config.yaml`, `rainmapper-app/Dockerfile`, cache-busters y changelog, y esta publicada en GHCR como `0.2.122/latest` con digest multi-arch `sha256:aeb39767d061671d1b75d810115d93e13dc9cd0776035e77f184ed3a577ee18e`. Incluye el experimento MapLibre heatmap de `0.2.121` en una ruta publica separada (`/local/rainmapper-maplibre-heatmap/index.html`) sin cambiar el visor protegido por defecto: boton `Heatmap`, selector y boton rapido de metrica (`Rain`, `Max temp`, `Min temp`, `Max humidity`, `Min humidity`, `Wind`), sliders de opacidad/radio, puntos/leyenda por metrica, heatmap mas amplio, heatmap por encima de puntos y fuente heatmap independiente del filtro de lluvia minima pero filtrada por fuentes activas. Ademas, lee incrementales grandes con inferencia completa para evitar los `DtypeWarning` de pandas vistos en `rainmapper.py` y `tomap.py`. `0.2.121` queda como version HA publicada con digest multi-arch `sha256:dcc820f91e3f05d0d80dbe43f55213c821ea75292a3833f37fb38934ca5bb0aa`. `0.2.120` queda como version HA publicada con digest multi-arch `sha256:9efce7f58351b4c1f3634cc7ce33e9ef389310544dc887caa199fd310f0ab2ad`. `0.2.119` queda como version HA publicada con digest multi-arch `sha256:d6220a7ce7b186b7c598cbadadcb2f11c3d3bf41de3b33c5272dfcf2d993fe95` e incluye alineacion de temperatura/humedad/viento en historial MapLibre, diagnostico/contadores AEMET `429` y botones `Update only` por fuente. `0.2.118` queda como version HA publicada y validada visualmente por el usuario el 2026-06-24, con digest multi-arch GHCR `sha256:07ce37c45de5f705aeb1621f4fb680a7b2c9360014ee1ccbb95322e7815d0e96`. Auditoria GitHub del 2026-06-24: el repo remoto esta publico (`private=false`, `visibility=public`) para que HA detecte updates. Siguiente paso recomendado: instalar/actualizar `0.2.122` en HA, validar visualmente el experimento heatmap y confirmar que desaparece el warning de pandas; despues volver a poner el repo privado y limpiar GHCR remoto conservando solo la version validada/latest y sus auxiliares multi-arch.
