...
`0.2.118` es la version local actual en `rainmapper-app/config.yaml`, `rainmapper-app/Dockerfile`, cache-busters y changelog. Queda publicada en GHCR con digest multi-arch `sha256:07ce37c45de5f705aeb1621f4fb680a7b2c9360014ee1ccbb95322e7815d0e96` y restaura la columna de dias y la cabecera sticky del historial MapLibre que se perdieron en `0.2.117`. `0.2.117` se conserva en GHCR como rollback con digest `sha256:e12749d4b16a48c362f731eb4f03dbb850b71988061602396c51293ad0350d65`. Auditoria GitHub del 2026-06-24: el repo remoto esta publico (`private=false`, `visibility=public`) para que HA detecte el update; volver a privado queda pendiente tras confirmar que HA ve/instala `0.2.118`. Siguiente paso recomendado: instalar `0.2.118` en HA y validar visualmente el popup MapLibre en escritorio y movil; despues, volver a poner el repo privado y limpiar GHCR remoto conservando solo la version validada/latest y sus auxiliares.
