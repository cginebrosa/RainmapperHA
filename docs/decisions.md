...
### Estado
Completado operacionalmente el 2026-06-22 y revisado de nuevo el 2026-06-24 tras `0.2.113`. `0.2.113` queda validado en HA y GHCR queda limpio conservando solo la version vigente, `latest` y sus auxiliares.
