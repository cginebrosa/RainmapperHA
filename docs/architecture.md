...
- El paquete remoto GHCR debe seguir accesible para Home Assistant si no se configura autenticacion de registry en HA. El 2026-06-24 se limpio GHCR tras validar `0.2.111`; despues se publicaron `0.2.112` y `0.2.113`. `0.2.113` resuelve como index OCI con `linux/amd64` y `linux/arm64` y digest `sha256:b8bdf0a9b433932c4fc7af012cd7d0876ea6d821aa7131b5e81458031c831627`. Conservar `0.2.111` como fallback hasta validar `0.2.113` en HA.
