class Station:
    ...
    :type url: `str`
    :param geolat: geopoint latitude of the station     --> Added
    :type geolat: `str`                                 --> Added
    :param geolon: geopoint longitude of the station    --> Added
    :type geolon: `str`                                 --> Added
    :returns: a *Station* instance
    :raises: *ValueError* when invalid empty or null values are provided
    """

    def __init__(self, name: str, code: str, url: str, geolat: str, geolon: str):  # Added geolat & geolon
        ...
        self.code = code
        self.url = url
        self.geolat = geolat        # Added latitude
        self.geolon = geolon        # Added longitude
